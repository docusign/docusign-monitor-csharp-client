...
namespace DocuSign.Monitor.Client
{
    ...
    public class ApiClient
    {
        ...
        public const string Production_REST_BasePath = "https://lens.docusign.net";
        // Sandbox/Demo base path 
        public const string Demo_REST_BasePath = "https://lens-d.docusign.net";
        // Stage base path
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://lens.docusign.net");
        }
        ...
        public ApiClient(String basePath = "https://lens.docusign.net", WebProxy proxy = null)
        {
        ...
        public void SetOAuthBasePath(string oAuthBasePath = null)
        {
            ...
            if (this.basePath.StartsWith("https://lens-d") || this.basePath.StartsWith("http://lens-d"))
            {
